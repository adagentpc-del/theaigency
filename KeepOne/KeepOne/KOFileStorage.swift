...
enum KOFileStorage {
    private static var fileURL: URL? {
        ...
        let directory = root.appendingPathComponent("KeepOne", isDirectory: true)
        try? manager.createDirectory(at: directory, withIntermediateDirectories: true)
        return directory.appendingPathComponent("battles.json")
    }
